...
const TEST_CASES = [
  {
    ...
    desc: "Real thumb vs Easy-altered thumb — same subject",
    verdict: "MATCH",
    model: "compact_siamese (Best)",
    subject: "Subject 100, Male, Left Thumb",
    fp1: { label: "Fingerprint A", meta: "REAL scan", source: "real",   difficulty: "Real",  alteration: "REAL",  emoji: "🔵" },
    fp2: { label: "Fingerprint B", meta: "Easy altered", source: "altered", difficulty: "Easy",  alteration: "Obl",   emoji: "🟢" },
    dist: 0.152,
    threshold: 0.381,
    triplet_loss: null,
  ...
  },
  {
    ...
    desc: "Real thumb vs Hard-altered thumb — same subject, heavy damage",
    verdict: "MATCH",
    model: "compact_siamese (Best)",
    subject: "Subject 247, Female, Right Index",
    fp1: { label: "Fingerprint A", meta: "REAL scan", source: "real",   difficulty: "Real", alteration: "REAL", emoji: "🔵" },
    fp2: { label: "Fingerprint B", meta: "Hard altered", source: "altered", difficulty: "Hard", alteration: "Obl",  emoji: "🟠" },
    dist: 0.341,
    threshold: 0.381,
    triplet_loss: null,
  ...
  },
  {
    ...
    desc: "Thumb from Subject 100 vs thumb from Subject 300 — different identities",
    verdict: "NO MATCH",
    model: "compact_siamese (Best)",
    subject: "Subject 100 vs Subject 300",
    fp1: { label: "Fingerprint A", meta: "Subject 100, REAL", source: "real", difficulty: "Real", alteration: "REAL", emoji: "🔵" },
    fp2: { label: "Fingerprint B", meta: "Subject 300, REAL", source: "real", difficulty: "Real", alteration: "REAL", emoji: "🔴" },
    dist: 0.712,
    threshold: 0.381,
    triplet_loss: null,
